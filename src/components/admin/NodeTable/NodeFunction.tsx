...
export function ActionsCell({ row }: { row: Row<z.infer<typeof schema>> }) {
  ...
  const generateCommand = () => {
    ...
    switch (selectedPlatform) {
      case "linux":
        finalCommand =
          `wget -qO- https://raw.githubusercontent.com/rabbits0209/komari-agent/refs/heads/main/install.sh | sudo bash -s -- ` +
          args.join(" ");
        break;
      case "windows":
        finalCommand =
          `powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ` +
          `"iwr 'https://raw.githubusercontent.com/rabbits0209/komari-agent/refs/heads/main/install.ps1'` +
      ...
      case "macos":
        finalCommand =
            `zsh <(curl -sL https://raw.githubusercontent.com/rabbits0209/komari-agent/refs/heads/main/install.sh) ` +
            args.join(" ");
        break;
    }
    return finalCommand;
